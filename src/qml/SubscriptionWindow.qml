...
ApplicationWindow {
    ...
    property string accentColor: "#28be46"
    ...
    Popup {
        ...
        Column {
            ...
            Row {
                ...
                TextButton {
                    ...
                    mainFontColorDefault: root.canActivate ? root.themeData.theme === "Dark" ? "#28be46" : "#28be46" : root.themeData.theme === "Dark" ? "#1b579c" : "#5ac671"
                    pointSizeOffset: root.platform === "Apple" ? 0 : -3
        ...
        Text {
            ...
            text: 'No license yet? &nbsp; <a href="https://github.com/nuttyartist/notes?utm_source=awesome_app" style="color:' + (root.themeData.theme === "Dark" ? '#12bd34' : '#28be46') + '; text-decoration: none;">Buy now</a>'
            width: 185
            color: root.themeData.theme === "Dark" ? "#dddddd" : "#272727"
            font.family: root.displayFontFamily
            font.pointSize: 13 + root.pointSizeOffset
        ...
        Column {
            ...
            Row {
                ...
                TextButton {
                    ...
                    mainFontColorDefault: root.themeData.theme === "Dark" ? "#12ca3c" : "#28be46"
                    pointSizeOffset: root.platform === "Apple" ? 0 : -3
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                TextButton {
                    ...
                    mainFontColorDefault: root.themeData.theme === "Dark" ? "#11bc34" : "#28be46"
                    mainFontColorPressed: root.themeData.theme === "Dark" ? "#1b7e30" : "#45cf64"
                    textFontWeight: Font.Normal
                    Layout.alignment: Qt.AlignHCenter
    ...
    Component {
        ...
        Row {
            ...
            Text {
                text: 'Or access all Pro features at no cost by building the app from <a href="https://github.com/nuttyartist/notes?utm_source=awesome_app" style="color:' + (root.themeData.theme === "Dark" ? '#46c15e' : '#28be46') + '; text-decoration: none;">source.</a>'
                width: 185
                color: root.themeData.theme === "Dark" ? "#dddddd" : "#272727"
                font.family: root.displayFontFamily
                    ...
                    Rectangle {
                        ...
                        Column {
                            ...
                            TextButton {
                                ...
                                pressedBackgroundColor: "transparent"
                                usePointingHand: false
                                mainFontColorDefault: root.themeData.theme === "Dark" ? "#5ac671" : "#25a83f"
                                mainFontColorPressed: root.themeData.theme === "Dark" ? "#25a63f" : "#47fa69"
                                textFontWeight: Font.Normal
                                Layout.alignment: Qt.AlignHCenter
                                backgroundSizeFitText: true
                                pointSizeOffset: root.platform === "Apple" ? 0 : -3
