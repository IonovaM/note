...
NodeTreeDelegate::NodeTreeDelegate(QTreeView *view, QObject *parent, QListView *listView)
    : QStyledItemDelegate{ parent },
      ...
      m_ActiveColor(80, 190, 80),
      m_notActiveColor(160, 230, 160),
      m_hoverColor(180, 208, 233),
      m_applicationInactiveColor(100, 190, 100),
...
void NodeTreeDelegate::setTheme(Theme::Value theme)
{
    ...
    case Theme::Light: {
        ...
        m_notActiveColor = QColor(175, 228, 204);
        m_hoverColor = QColor(200, 230, 200);
    ...
    case Theme::Dark: {
        ...
        m_notActiveColor = QColor(34, 68, 50);
        m_hoverColor = QColor(34, 68, 50);
                                        ...
                                        const QModelIndex &index) const
{
    ...
    if (itemType == NodeItem::Type::FolderSeparator || itemType == NodeItem::Type::TagSeparator) {
        ...
        addButton->setStyleSheet(QStringLiteral(R"(QPushButton { )"
                                                R"(    border: none; )"
                                                R"(    padding: 0px; )"
                                                R"(    color: rgb(40, 190, 70); )"
                                                R"(})"
                                                R"(QPushButton:hover { )"
                                                R"(    border: none; )"
                                                R"(    padding: 0px; )"
                                                R"(    color: rgb(20, 140, 40); )"
                                                R"(})"
                                                R"(QPushButton:pressed { )"
                                                R"(    border: none; )"
                                                R"(    padding: 0px; )"
                                                R"(    color: rgb(20, 140, 50); )"
                                                R"(})"));
        if (itemType == NodeItem::Type::FolderSeparator) {
