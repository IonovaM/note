                                         ...
                                         const QModelIndex &index) const
{
    ...
    if (model && model->hasPinnedNote()) {
        if (model->isFirstPinnedNote(index)) {
            ...
            painter->setPen(QColor(40, 190, 70));
...
void NoteListDelegateEditor::setTheme(Theme::Value theme)
{
    ...
    case Theme::Light: {
        ...
        m_ActiveColor = QColor(219, 240, 220);
        m_notActiveColor = QColor(219, 240, 230);
    ...
    case Theme::Dark: {
        ...
        m_ActiveColor = QColor(42, 89, 30, 127);
        m_notActiveColor = QColor(42, 89, 30);
        m_hoverColor = QColor(42, 89, 30);
        m_applicationInactiveColor = QColor(42, 89, 30);
