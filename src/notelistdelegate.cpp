...
void NoteListDelegate::setTheme(Theme::Value theme)
{
    ...
    case Theme::Light: {
        ...
        m_notActiveColor = QColor(186, 228, 175);
    ...
    case Theme::Dark: {
        ...
        m_ActiveColor = QColor(34, 68, 59, 127);
        m_notActiveColor = QColor(34, 68, 59);
        m_hoverColor = QColor(34, 68, 59, 127);
        m_applicationInactiveColor = QColor(34, 68, 59);
